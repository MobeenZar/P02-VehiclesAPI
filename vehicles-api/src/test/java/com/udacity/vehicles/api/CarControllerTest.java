...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        /**
         *   Test to check that the `get` method works by calling
         *   the whole list of vehicles.
         *   Body = {"_embedded":{"carList":[{"id":1,"createdAt":null,"modifiedAt":null,"condition":"USED","details":{"body":"sedan","model":"Impala"
         */
    ...
    public void deleteCar() throws Exception {
        /**
         *   Test to check whether a vehicle is appropriately deleted
